...
class AgendaController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_agenda_show', array('id' => $agenda->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_agenda_show")
     * @Method("GET")
     */
    ...
    public function editAction(Request $request, Agenda $agenda)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_agenda_edit', array('id' => $agenda->getId()));
        }
